    ...
    <div style={{ padding: "24px" }}>
      <Card
        ...
        extra={
          <Space>
            ...
            {!canEdit && !canApprove && (
              <Tag color="orange">View Only Mode</Tag>
            )}
          </Space>
        }
      >
        ...
        {!canEdit && !canApprove && (
          ...
          >
            <span style={{ color: "#fa8c16" }}>
              ⚠️ Only Education Officers can manage courses. Only Administrators
              can approve/reject.
            </span>
          </div>
        )}
      ...
      >
        <Form form={form} layout="vertical" name="courseForm">
          ...
          >
            <Input placeholder="e.g., COURSE001" disabled={!!editingCourse} />
          </Form.Item>
