    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background:
            "linear-gradient(to right, rgba(0, 40, 80, 0.15) 0%, rgba(0, 80, 120, 0.05) 100%)",
          zIndex: 1,
        }}
      />
      ...
      <div
        style={{
          ...
          padding: "50px 40px",
          boxShadow:
            "0 20px 60px rgba(0, 0, 0, 0.3), 0 0 1px rgba(255, 255, 255, 0.5), inset 0 0 60px rgba(255, 255, 255, 0.1)",
      ...
      >
        ...
        >
          ...
          >
            <Input
              prefix={
                <UserOutlined style={{ color: "#555", fontSize: "16px" }} />
              }
              placeholder="user"
              size="large"
              style={{
          ...
          >
            <Input.Password
              prefix={
                <LockOutlined style={{ color: "#555", fontSize: "16px" }} />
              }
